...
1. Find the app key `9fbb6e1b-461f-4bb4-8682-f983c2b5e297` and replace the existing value with your Azure AD tenant name.
...
1. Find the app key `15992c9e-f146-4863-b4cc-dd56c87635a7` and replace the existing value with the application ID (clientId) of the `python-webapp` application copied from the Azure portal.
