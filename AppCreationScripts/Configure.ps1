...
#> 
   ...
   $requiredPermissions = GetRequiredPermissions -applicationDisplayName "Microsoft Graph" `
                                                -requiredDelegatedPermissions ["User.ReadBasic.All", "Mail.Read", "Mail.ReadBasic", "Mail.ReadWrite", "MailboxSettings.Read", "MailboxSettings.ReadWrite", "Files.Read", "Files.Read.All", "Files.ReadWrite", "Files.ReadWrite.All", "Team.Create"] `
   ...
   $dictionary = @{ "9fbb6e1b-461f-4bb4-8682-f983c2b5e297" = $tenantName;"jpC8Q~Kr67PugFQsieU8XlqLCzfheAwuD0E4ldiD" = $pythonwebappAppKey;"15992c9e-f146-4863-b4cc-dd56c87635a7" = $pythonwebappAadApplication.AppId };
